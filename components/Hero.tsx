    ...
    return (
        <section id="hero" className="w-full flex lg:flex-row flex-col justify-between items-start">
            ...
            <div id="content-section" className="lg:w-[50%] w-full flex flex-col justify-center items-center gap-10 p-20">
                ...
                {/* Corrected h1 tag with the right data-aos attributes */}
                <h1 data-aos="zoom-in" data-aos-delay="400" className="text-[50px] text-center leading-[55px]">
                    Fresh Breads<br />Handcrafted daily
                </h1>
                <p data-aos="zoom-in" data-aos-delay="400" className="text-center text-xl text-slate-600">we believe food is not just a meal — it's an emotion. Inspired by India’s rich culinary heritage, we serve a wide variety of traditional and modern Indian dishes prepared with love and the finest ingredients.</p>
